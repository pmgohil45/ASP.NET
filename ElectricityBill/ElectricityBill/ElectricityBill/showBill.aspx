<%@ Page Language="C#" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="showBill.aspx.cs" Inherits="ElectricityBill.showBill"  EnableEventValidation="false"%>
<!DOCTYPE html>
                ...
                <table align="center" border="1" id="printTable">
                    ...
                    <tr>
                        <td align="right" colspan="10">
                            ...
                            <asp:Button ID="btnDownload" runat="server" name="btnPrint" OnClick="btnDownload_Click1" Text="Download Bill" type="submit" value="Print" />
