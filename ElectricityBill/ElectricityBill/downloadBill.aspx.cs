...
namespace ElectricityBill
{
    public partial class downloadBill : System.Web.UI.Page
    {
        ...
        public void dateFunction()
        {
            ...
            labelPaymentDate.Text = labelLastDate.Text;
        ...
        public void checkBillValidity()
        {
            ...
            //currentDt = DateTime.Now.AddMonths(1).ToString("dd-MM-yyyy"); //for the bill testing
            ...
            {
                billPanel.Visible = false;
                //ScriptManager.RegisterClientScriptBlock(this, url.GetType(), "alertMessage", "alert('Record Inserted Successfully')", true);

                string script = "alert(\"Please try after one month...\" )";
