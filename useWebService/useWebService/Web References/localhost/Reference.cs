...
namespace useWebService.localhost {
    ...
    public partial class WebService1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebService1() {
            this.Url = global::useWebService.Properties.Settings.Default.useWebService_localhost_WebService1;
        ...
        /// <remarks/>
        public void searchAsync(string con, string table, string id) {
            this.searchAsync(con, table, id, null);
        }
        
        /// <remarks/>
        public void searchAsync(string con, string table, string id, object userState) {
            ...
            this.InvokeAsync("search", new object[] {
                        con,
                        table,
                        id}, this.searchOperationCompleted, userState);
        }
